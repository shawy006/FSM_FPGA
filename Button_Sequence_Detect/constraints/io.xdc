...
set_property -dict { PACKAGE_PIN M19  IOSTANDARD LVCMOS33 } [get_ports { clr_n }]; #IO_L7P_T1_AD2P_35 Sch=SW1

## RGB LEDs
set_property -dict { PACKAGE_PIN L15    IOSTANDARD LVCMOS33 } [get_ports { blue }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
...
## Buttons
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { enter }]; #IO_L4P_T0_35 Sch=BTN0
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { toneout  }]; #IO_L5P_T0_34            Sch=CK_IO0
